...
INTEGER, PARAMETER :: N_OUTPUT_QUANTITIES=550,N_Q_DOT=9,N_M_DOT=4
...
OUTPUT_QUANTITY(186)%NAME = 'EQUILIBRIUM VAPOR FRACTION'
OUTPUT_QUANTITY(186)%UNITS = 'kg/kg'
OUTPUT_QUANTITY(186)%SHORT_NAME = 'Y_eq'
OUTPUT_QUANTITY(187)%NAME = 'EQUILIBRIUM TEMPERATURE'
OUTPUT_QUANTITY(187)%UNITS = 'C'
OUTPUT_QUANTITY(187)%SHORT_NAME = 'T_eq'
OUTPUT_QUANTITY(186:187)%SPEC_ID_REQUIRED = .TRUE.
OUTPUT_QUANTITY(186:187)%ISOF_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(186:187)%PART_APPROPRIATE = .FALSE.
OUTPUT_QUANTITY(186:187)%SLCF_APPROPRIATE = .FALSE.
...
! Group Force
OUTPUT_QUANTITY(252)%NAME  = 'GROUP_FORCE'
OUTPUT_QUANTITY(252)%UNITS = '  '
OUTPUT_QUANTITY(252)%SHORT_NAME  = 'groupF'

! Hazard Force
OUTPUT_QUANTITY(253)%NAME  = 'HAZARD_FORCE'
OUTPUT_QUANTITY(253)%UNITS = '  '
OUTPUT_QUANTITY(253)%SHORT_NAME  = 'hazardF'
...
OUTPUT_QUANTITY(504:505)%DEVC_APPROPRIATE = .TRUE.
OUTPUT_QUANTITY(504:505)%INTEGRATED = .TRUE.
